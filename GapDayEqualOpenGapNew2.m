function Table=GapDayEqualOpenGapNew2(Project)
...
SlopeList2=(0:1:45);
[Slope2, Aspect2]=meshgrid(SlopeList2, AspectList);

DayCumMapforSlopeASpect2=zeros(length(SlopeList2),length(AspectList));

iAspect=0;
for Aspect2=AspectList 
   iAspect=iAspect+1;
   
   DayCumMapforSlopeASpect2(:,iAspect)= spline(SlopeList, DayCumMapforSlopeASpect(:,iAspect),SlopeList2);
end
...
[ch ch]=contourf(Aspect2 ,Slope2,DayCumMapforSlopeASpect2');
