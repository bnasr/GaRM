function [mN mL mS Net Lnet Snet rTransect r w vN vLn vSn Sin Lin mSin mLin percBelowOpen R_open S_open L_open OpenAll GapAll]=GapModel2(H,HeightMap,R,Slope,Aspect,Site,plotoff,SVF)
NoC=20;
...
for i=1:Site.NW+1
    for j=1:Site.NR
        ...
        dTMap(i,j)=sum(dT.*CVF(:,i,j)./sum(CVF(:,i,j)));
    end
end
